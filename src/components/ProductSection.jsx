...
export default function ProductSection({ onSelectProduct, onOpenQuoteModal }) {
  ...
  return (
    <section id="products" className="py-20 lg:py-24 cotton-weave-bg bg-slate-50 relative overflow-hidden border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`relative px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold whitespace-nowrap transition-all duration-300 flex items-center gap-2 ${
                  isActive
        ...
        <div className="mt-16 rounded-2xl p-8 sm:p-10 bg-brand-900 border border-brand-700/80 relative overflow-hidden shadow-2xl text-white">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-white mt-1 font-serif">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto shrink-0">
              <button
                ...
                className="w-full sm:w-auto px-7 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 via-brand-500 to-brand-600 hover:from-blue-500 hover:to-brand-500 text-white font-bold text-sm shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shimmer-sweep"
              >
              ...
              <a
                href="#manufacturing"
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-brand-800 border border-brand-700/80 text-slate-200 hover:text-white text-sm font-semibold text-center hover:border-brand-400 transition-all flex items-center justify-center gap-2"
              >
