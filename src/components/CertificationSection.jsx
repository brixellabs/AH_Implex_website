...
export default function CertificationSection({ onOpenQuoteModal }) {
  ...
  return (
    <section id="certifications" className="py-20 lg:py-24 bg-slate-50 relative overflow-hidden border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {CERTIFICATIONS.map((cert, idx) => (
            <motion.div
              ...
              className="group bg-white rounded-2xl p-7 border border-slate-200 shadow-sm hover:shadow-2xl hover:border-brand-500 transition-all duration-300 flex flex-col justify-between cursor-pointer relative overflow-hidden"
            >
              ...
              <div>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 rounded-xl bg-brand-50 border border-brand-200 text-brand-700 flex items-center justify-center group-hover:scale-105 group-hover:bg-brand-600 group-hover:text-white transition-all shadow-sm">
                    <FontAwesomeIcon icon={faCertificate} className="text-xl" aria-hidden="true" />
                  </div>
                ...
                <h3 className="text-xl font-bold text-slate-900 tracking-tight group-hover:text-brand-700 transition-colors mb-1 font-serif">
                  {cert.code}
                </h3>
                <p className="text-xs uppercase tracking-wider text-brand-700 font-bold mb-3 font-mono">
                  {cert.title}
                </p>

                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed mb-6 line-clamp-3 font-normal">
                  {cert.description}
                </p>

                {/* Scope */}
                <div className="bg-slate-50 rounded-xl p-3 border border-slate-200 mb-4 text-xs">
                  <span className="text-[11px] text-slate-500 uppercase tracking-wider font-semibold block mb-0.5 font-mono">
                    Certified Scope:
                  </span>
                  <span className="text-slate-800 font-medium">{cert.scope}</span>
                </div>
              </div>
        ...
        <div className="mt-12 p-4 rounded-xl bg-white border border-slate-200 text-center text-xs text-slate-600 max-w-2xl mx-auto shadow-sm">
          <p>
        ...
        {selectedCert && (
          ...
          >
            <motion.div
              ...
              className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 max-w-xl w-full shadow-2xl relative text-slate-900"
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-xl bg-brand-50 border border-brand-200 text-brand-700 flex items-center justify-center">
                  <FontAwesomeIcon icon={faCertificate} className="text-xl" aria-hidden="true" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-slate-900 font-serif">{selectedCert.code}</h3>
                  <p className="text-xs text-brand-700 uppercase tracking-wider font-bold font-mono">{selectedCert.title}</p>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-6 bg-slate-50 p-4 rounded-xl border border-slate-200">
                <h4 className="text-xs uppercase tracking-wider text-slate-500 font-bold mb-2 font-mono">
              ...
              {/* Status Notice */}
              <div className="p-3.5 rounded-lg bg-brand-50 border border-brand-200 text-xs text-brand-900 mb-6 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <span className="text-slate-600 font-normal">{selectedCert.statusText}. High-resolution PDF copy will be provided during formal contract onboarding.</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl bg-gradient-to-r from-blue-600 via-brand-500 to-brand-600 text-white font-bold text-xs uppercase tracking-wider shadow-lg hover:scale-[1.01] active:scale-[0.98] transition-all shimmer-sweep"
                >
