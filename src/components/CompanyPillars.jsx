      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {PILLARS.map((pillar, idx) => (
          <motion.a
            ...
            className="group relative glass-card glass-card-hover rounded-2xl p-7 shadow-xl border border-brand-700/60 flex flex-col justify-between overflow-hidden cursor-pointer"
          >
            ...
            <div>
              ...
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-800 to-brand-900 border border-brand-500/30 flex items-center justify-center text-brand-300 mb-5 group-hover:scale-105 group-hover:border-brand-300/60 transition-all shadow-md">
                <FontAwesomeIcon icon={pillar.icon} className="text-lg" aria-hidden="true" />
              </div>

              <div className="flex items-center justify-between mb-1">
                <h3 className="text-lg font-bold text-white tracking-wide group-hover:text-brand-200 transition-colors font-serif">
                  {pillar.title}
                </h3>
              ...
              <p className="text-xs uppercase tracking-wider text-brand-300 font-semibold mb-3 font-mono">
                {pillar.subtitle}
              </p>
            ...
            <div className="mt-5 pt-4 border-t border-brand-700/40 flex items-center gap-1 text-xs font-semibold text-brand-300 group-hover:text-white">
