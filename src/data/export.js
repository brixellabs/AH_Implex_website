...
export const EXPORT_REGIONS = [
  {
    ...
    share: '38%',
    description: 'Supplying hotel chains, department stores, and retail brands with high-thread-count bed linen and certified OEKO-TEX textiles.',
  ...
  },
  {
    ...
    share: '32%',
    description: 'High-volume contract supply of fitted sheet suites, sateen sets, and casual apparel with US Customs & C-TPAT compliant container packing.',
  ...
  },
  {
    ...
    share: '15%',
    description: 'Institutional dining linens, boutique resort bedding, and custom private-label home furnishings.',
...
export const SHIPPING_CAPABILITIES = [
  ...
  },
  {
    ...
    description: 'Seamless execution of FOB, CIF, CFR, DDP, and EXW agreements tailored to your freight forwarder or direct consignee requirements.',
    icon: 'FileCheck'
  },
  {
